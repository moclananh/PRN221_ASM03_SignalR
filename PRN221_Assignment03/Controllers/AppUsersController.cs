...
namespace PRN221_Assignment03.Controllers
{
    public class AppUsersController : Controller
    {
        ...
        public AppUsersController(Prn221Asm03Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.AppUsers != null ? 
                          ...
                          Problem("Entity set 'Prn221Asm03Context.AppUsers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Prn221Asm03Context.AppUsers'  is null.");
            }
            var appUser = await _context.AppUsers.FindAsync(id);
            if (appUser != null)
            {
